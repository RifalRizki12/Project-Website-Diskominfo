...
<!-- Mirrored from slimhamdi.net/amira/demos/index-kenburns.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Feb 2021 18:24:26 GMT -->
<head>
    <meta charset="utf-8" />
                ...
                <nav class="navbar">
					...
					<div id="navbarSupportedContent" class="collapse navbar-collapse navbar-responsive-collapse">
						...
						<ul class="nav navbar-nav" id="main-navigation">
							<li class=""><a href="{{route('/')}}"><i class="fa fa-home"></i> Beranda</a></li>
                            <li class="dropdown">
